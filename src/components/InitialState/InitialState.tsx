export const initialState = {
  ...
  colorOptions: [
    { key: 'option_0', image: 'src/assets/img/first.png' },
    { key: 'option_1', image: 'src/assets/img/second.png' },
    { key: 'option_2', image: 'src/assets/img/third.png' },
    { key: 'option_3', image: 'src/assets/img/forth.png' }
  ],
  colorOptionsMobile: [
